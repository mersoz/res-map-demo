...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return mapSettings; });
/* unused harmony export LINE_PATH_CONFIG */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return POINT_MARKER_ICON_CONFIG; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__colorPalette__ = __webpack_require__(388);


var COLOR_LANDSCAPE = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_LANDSCAPE,
    COLOR_BORDERS = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_BORDERS,
    COLOR_WATER = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_WATER,
    COLOR_LINE = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_LINE,
    COLOR_POINT_FILL = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_POINT_FILL,
    COLOR_SELECTED_POINT = __WEBPACK_IMPORTED_MODULE_0__colorPalette__["a" /* default */].COLOR_SELECTED_POINT;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_array_merge_by_key__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_array_merge_by_key___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_array_merge_by_key__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_TravelMap__ = __webpack_require__(378);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  name: "App",
  components: {
    TravelMap: __WEBPACK_IMPORTED_MODULE_2__components_TravelMap__["a" /* default */]
  },
  data: function data() {
    return {
      errors: [],
  ...
  methods: {
    retrieveProperties: function retrieveProperties() {
      var vm = this;
      vm.disableButton = true;

      var corsUrl = 'https://morning-sea-48633.herokuapp.com/';
      var resoluteUrl = 'http://resolute-204310.appspot.com/';
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.baseURL = corsUrl + resoluteUrl;

      function getLocations() {
        return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/locations');
      }

      function getFeatures() {
        return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/features');
      }

      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.all([getLocations(), getFeatures()]).then(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.spread(function (locations, features) {
    ...
    markLocations: function markLocations() {
      var mergedResponses = __WEBPACK_IMPORTED_MODULE_1_array_merge_by_key___default()('id', this.features, this.locations);
    ...
    recenterMap: function recenterMap() {
      var sumLat = this.locations.map(function (location) {
        return location.position.lat;
      }).reduce(function (total, amount) {
        return total + amount;
      });
      var averageLat = sumLat / this.locations.length;

      var sumLng = this.locations.map(function (location) {
        return location.position.lng;
      }).reduce(function (total, amount) {
        return total + amount;
      });
      var averageLng = sumLng / this.locations.length;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__GoogleMapLoader__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__GoogleMapMarker__ = __webpack_require__(387);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__GoogleMapInfoWindow__ = __webpack_require__(389);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constants_mapSettings__ = __webpack_require__(98);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    GoogleMapLoader: __WEBPACK_IMPORTED_MODULE_0__GoogleMapLoader__["a" /* default */],
    GoogleMapMarker: __WEBPACK_IMPORTED_MODULE_1__GoogleMapMarker__["a" /* default */],
    GoogleMapInfoWindow: __WEBPACK_IMPORTED_MODULE_2__GoogleMapInfoWindow__["a" /* default */]
  },
  props: {
    markers: Array,
    center: Object,
  ...
  computed: {
    mapConfig: function mapConfig() {
      return _extends({}, __WEBPACK_IMPORTED_MODULE_3__constants_mapSettings__["b" /* mapSettings */], {
        center: this.center,
        zoom: this.zoom
      });
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_google_maps_api_loader__ = __webpack_require__(382);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_google_maps_api_loader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_google_maps_api_loader__);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return __WEBPACK_IMPORTED_MODULE_0_google_maps_api_loader___default()({
                apiKey: _this.apiKey
              });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_mapSettings__ = __webpack_require__(98);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  props: {
    ...
    marker: {
      type: Object,
      required: true
      // (:options="infoOptions" :position="infoPosition" :opened="infoOpened", :content="infoContent", @closeclick="infoOpened=false")
    } },
  data: function data() {
    return {
      contentString: "hellooooooooo"
    };
  },
  mounted: function mounted() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__App_vue__ = __webpack_require__(354);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(44), __webpack_require__(352).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(44), __webpack_require__(96)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(137);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_35ef9528_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(391);
...
/* scopeId */
var __vue_scopeId__ = "data-v-35ef9528"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_App_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_35ef9528_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
var update = __webpack_require__(136)("159bef16", content, true, {});
...
// module
exports.push([module.i, "[data-v-35ef9528]{font-family:Open Sans,sans-serif}.travel-map[data-v-35ef9528]{height:70vh}button[data-v-35ef9528]{display:block;background-color:#2e96fa;margin:5px auto;width:100%;padding:10px 20px;border:1px outset rgba(158,219,255,.5);letter-spacing:2px;font-family:Open Sans,sans-serif;text-transform:uppercase;font-size:14px;color:#fff}.instructions[data-v-35ef9528]{width:800px;min-width:700px;margin:0 auto}.instructions b[data-v-35ef9528]{color:#2e96fa}", ""]);
...
axios.spread = __webpack_require__(376);
...
var defaults = __webpack_require__(97);
var isAbsoluteURL = __webpack_require__(373);
var combineURLs = __webpack_require__(374);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_TravelMap_vue__ = __webpack_require__(143);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f3aedf9e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_TravelMap_vue__ = __webpack_require__(390);
var normalizeComponent = __webpack_require__(54)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_TravelMap_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f3aedf9e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_TravelMap_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapLoader_vue__ = __webpack_require__(144);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d666d860_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_GoogleMapLoader_vue__ = __webpack_require__(386);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-d666d860"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapLoader_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d666d860_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_template_compiler_preprocessor_engine_pug_node_modules_vue_loader_lib_selector_type_template_index_0_GoogleMapLoader_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(136)("138ddde1", content, true, {});
...
// module
exports.push([module.i, ".google-map[data-v-d666d860]{width:100%;min-height:100%}", ""]);
...
var Promise = __webpack_require__(384).Promise;
var urlBuilder = __webpack_require__(385);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(96), __webpack_require__(44)))
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{ref:"googleMap",staticClass:"google-map"}),(Boolean(this.google) && Boolean(this.map))?[_vm._t("default",null,{"google":_vm.google,"map":_vm.map})]:_vm._e()],2)}
var staticRenderFns = []
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapMarker_vue__ = __webpack_require__(145);
/* unused harmony namespace reexport */
var normalizeComponent = __webpack_require__(54)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapMarker_vue__["a" /* default */],
  __vue_template__,
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  COLOR_LANDSCAPE: "#EDEDED",
  COLOR_BORDERS: "FFAD00",
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapInfoWindow_vue__ = __webpack_require__(146);
/* unused harmony namespace reexport */
var normalizeComponent = __webpack_require__(54)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_GoogleMapInfoWindow_vue__["a" /* default */],
  __vue_template__,
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('GoogleMapLoader',{ref:"googleMapLoader",attrs:{"mapConfig":_vm.mapConfig,"apiKey":"AIzaSyBVYiwPWVIsYzgHS8zlxv16XwJbOpEUmjI","center":_vm.center,"zoom":_vm.zoom,"markers":_vm.markers,"bounds":_vm.bounds},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var google = ref.google;
var map = ref.map;
return [_c('div',{staticClass:"ooboo"},_vm._l((_vm.markers),function(marker){return _c('GoogleMapMarker',{key:marker.id,attrs:{"marker":marker,"google":google,"map":map},on:{"mouseover":_vm.displayInfo,"hover":_vm.displayInfo},nativeOn:{"click":function($event){return _vm.displayInfo($event)}}})}),1)]}}])})}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('button',{attrs:{"type":"button","disabled":_vm.disableButton},on:{"click":_vm.retrieveProperties}},[_vm._v("Retrieve properties")]),_c('TravelMap',{staticClass:"travel-map",attrs:{"markers":_vm.markers,"center":_vm.center,"zoom":_vm.zoom,"infoWindow":_vm.infoWindow}}),_vm._m(0)],1)}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"instructions"},[_c('p',[_vm._v("Click"),_c('b',[_vm._v(" Retrieve Properties")]),_vm._v(" to get properties, the map will zoom to the markers")]),_c('p',[_vm._v("Hover over a marker to display info popup with property details and a StreetView image")]),_c('p',[_vm._v("Click on the map to close all popups and"),_c('b',[_vm._v(" X")]),_vm._v(" to close individual popups")])])}]
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
